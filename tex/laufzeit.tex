...
\begin{itemize}
  ...
  Wie es in der \nameref{sec:umsetzung} vermerkt wird, ist die Struktur der Beispiel aus der BWINF--Webseite
  sehr spezifisch.
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Die vorgegangene Liste wird zu \ttt{all\_fruits} kopiert: $O(n \log n)$\footref{foot:vergleich-aufwand}
    \end{itemize}
