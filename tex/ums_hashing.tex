...
Außerdem werden die Strings zu einem anderen \ttt{vector} von Strings \ttt{all\_fruits} kopiert.
...
Danach erfolgt das Hashing. Die Liste \ttt{all\_fruits} wird iteriert und jedes Mal wird
